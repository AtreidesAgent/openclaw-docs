---
title: "MyMingo offers single-click solution for Flamingo users to convert FLM into any supported LP"
date: 2021-04-29
url: https://neonewstoday.com/general/mymingo-offers-single-click-solution-for-flamingo-users-to-convert-flm-into-any-supported-lp/
tags: [General, FLM]
source: neonewstoday
---
...
If a user wants to remove their stake from a particular LP, they must do so on the Flamingo Finance platform. Those services are currently not available via MyMingo.

Looking forward, MyMingo users are encouraged to join the official Discord server to provide feedback on the application. Additionally, the team plans to include analytics surrounding impermanent loss.

MyMingo can be accessed at the following link:

https://mymingo.finance/

The post MyMingo offers single-click solution for Flamingo users to convert FLM into any supported LP appeared first on Neo News Today.
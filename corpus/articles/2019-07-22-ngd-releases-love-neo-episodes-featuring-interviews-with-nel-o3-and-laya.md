---
title: "NGD releases LOVE NEO episodes featuring interviews with NEL, O3 and LAYA"
date: 2019-07-22
url: https://neonewstoday.com/general/ngd-releases-love-neo-episodes-featuring-interviews-with-nel-o3-and-laya/
tags: [General, NEL, NEO, O3]
source: neonewstoday
---

# NGD releases LOVE NEO episodes featuring interviews with NEL, O3 and LAYA

**Published:** Mon, 22 Jul 2019 10:29:43 +0000
**URL:** https://neonewstoday.com/general/ngd-releases-love-neo-episodes-featuring-interviews-with-nel-o3-and-laya/
**Tags:** General, NEL, NEO, O3

---

As part of an on-going initiative to provide exposure to NEO-based projects, NEO Global Development (NGD) has released three new LOVE NEO videos. The three new episodes feature interviews with representatives from: NewEconoLabs (NEL), a China-based NEO community development group; O3 Labs, a Japan based development group focused on NEO infrastructure, and; LAYA.ONE, a blockchain game ecosystem platform.

NewEconoLabs

In the NEL episode, founder Yongxin Liu spoke with NGD associate manager, Nikkor Wang, discussing the NEO Name Credit (NNC) token, Teemo wallet, and the development group’s future plans.
...
In another recently released NEO LOVE episode, three members of the O3 Labs team were interviewed by Longfei Wang, NGD blockchain engineer, and Denis Suslov, associate manager in NEO ecosystem growth. Representing O3 Labs was Apisit Toompakdee, O3 Labs co-founder, Arco Oliemans, business development manager, and Nick Fujita, senior blockchain developer.
...
Wang said, “To be frank, blockchain game development is way more difficult than traditional game development. If you choose to do blockchain games, you must have a certain expectation and curiosity.”
...
Looking forward, LAYA.ONE aims to integrate NEO, Ethereum, and EOS support into its game engine platform, which will eventually assist in the migration of traditional games to NEO.

                                    

The post NGD releases LOVE NEO episodes featuring interviews with NEL, O3 and LAYA appeared first on Neo News Today.
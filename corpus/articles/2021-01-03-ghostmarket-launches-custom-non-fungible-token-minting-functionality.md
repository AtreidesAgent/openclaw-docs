---
title: "GhostMarket launches custom non-fungible token minting functionality"
date: 2021-01-03
url: https://neonewstoday.com/general/ghostmarket-launches-custom-non-fungible-token-minting-functionality/
tags: [Exchanges, General, NFT, GAS, GhostMarket, GM, NEO]
source: neonewstoday
---

# GhostMarket launches custom non-fungible token minting functionality

**Published:** Sun, 03 Jan 2021 00:02:16 +0000
**URL:** https://neonewstoday.com/general/ghostmarket-launches-custom-non-fungible-token-minting-functionality/
**Tags:** Exchanges, General, NFT, GAS, GhostMarket, GM, NEO

---

GhostMarket has launched its uMint NFT Factory, allowing users to mint custom non-fungible tokens. Currently, GhostMarket supports NFT minting on the Phantasma blockchain. However, smart contracts for NFT trading and minting will soon be supported on Neo and other blockchains.
...
Phantasma Chain recently released a video on using the uMint NFT Factory:
...
GhostMarket is an NFT marketplace and explorer that launched in July 2020. It was designed and created by Ghostdevs, an open-source developer community in the Phantasma ecosystem. At the time of press, GhostMarket has approximately 260 users, conducted 8,040 total transactions, and hosted volume of US $49,520.

The GhostMarket platform can be found at the link below:

https://ghostmarket.io/

The post GhostMarket launches custom non-fungible token minting functionality appeared first on Neo News Today.
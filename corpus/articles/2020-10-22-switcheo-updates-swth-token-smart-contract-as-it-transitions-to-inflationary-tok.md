---
title: "Switcheo updates SWTH token smart contract as it transitions to inflationary token economic model"
date: 2020-10-22
url: https://neonewstoday.com/general/switcheo-updates-swth-token-smart-contract-as-it-transitions-to-inflationary-token-economic-model/
tags: [Exchanges, General, NEO, SWTH]
source: neonewstoday
---

# Switcheo updates SWTH token smart contract as it transitions to inflationary token economic model

**Published:** Thu, 22 Oct 2020 22:00:51 +0000
**URL:** https://neonewstoday.com/general/switcheo-updates-swth-token-smart-contract-as-it-transitions-to-inflationary-token-economic-model/
**Tags:** Exchanges, General, NEO, SWTH
...
The post Switcheo updates SWTH token smart contract as it transitions to inflationary token economic model appeared first on Neo News Today.
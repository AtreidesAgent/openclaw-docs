---
title: "Zeepin provides guide to its NEP-5 to MainNet token swap"
date: 2018-09-24
url: https://neonewstoday.com/general/zeepin-provides-guide-to-its-nep-5-to-mainnet-token-swap/
tags: [General, GALA, ZPT]
source: neonewstoday
---

# Zeepin provides guide to its NEP-5 to MainNet token swap

**Published:** Mon, 24 Sep 2018 22:52:49 +0000
**URL:** https://neonewstoday.com/general/zeepin-provides-guide-to-its-nep-5-to-mainnet-token-swap/
**Tags:** General, GALA, ZPT
...
- Import a NEO wallet private key, and

- Use Ledger.

Further information on how to use either of the two methods can be found at the following link:

https://medium.com/@zeepin/zeewallet-download-and-token-swap-tutorial-b1175f6bdef2 
...
The post Zeepin provides guide to its NEP-5 to MainNet token swap appeared first on Neo News Today.
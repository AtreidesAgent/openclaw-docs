---
title: "Neo News: Week in Review – February 6 – February 12"
date: 2023-02-13
url: https://neonewstoday.com/week-in-review/neo-news-week-in-review-february-6-february-12/
tags: [Gaming, Week In Review, AfricaN3, AxLabs, bNEO, COZ, DogeRift, FindTruman, FLM, fUSDT, GhostMarket, GM, GrantShares, MercurialApps, ndapp, NeoResearch, NeoSPCC, NEXT, PinkPaper, QuirkySoulCollege, Red4Sec]
source: neonewstoday
---

# Neo News: Week in Review – February 6 – February 12

**Published:** Mon, 13 Feb 2023 19:26:04 +0000
**URL:** https://neonewstoday.com/week-in-review/neo-news-week-in-review-february-6-february-12/
**Tags:** Gaming, Week In Review, AfricaN3, AxLabs, bNEO, COZ, DogeRift, FindTruman, FLM, fUSDT, GhostMarket, GM, GrantShares, MercurialApps, ndapp, NeoResearch, NeoSPCC, NEXT, PinkPaper, QuirkySoulCollege, Red4Sec
...
Neo’s developer community provided a video update for Dec. 2022 and Jan. 2023, which included updates about various tools, projects, and events. The video featured segments from AxLabs (neow3j, GrantShares), COZ (Neon Wallet, Dora, Neo Python Suite, Contract Package Manager, WalletConnect, PROPS), NNT (GasBot, nDapp.org),  NEXT (NeoLine), NeoResearch (Education initiatives, dBFT 3.0, Zero Knowledge Proofs), NeoSPCC (NeoFS, NeoGo), NGD Digital Labs (Neo Core, Lounge, Decoding Web3, NeoNS, NeoChat), NGD Enterprise (Code coverage, WorkNet, Neo Blockchain Toolkit), and Red4Sec (Security audits).
...
The post Neo News: Week in Review – February 6 – February 12 appeared first on Neo News Today.

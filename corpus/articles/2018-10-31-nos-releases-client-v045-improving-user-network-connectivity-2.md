---
title: "nOS releases Client v0.4.5 improving user network connectivity"
date: 2018-10-31
url: https://neonewstoday.com/general/nos-releases-client-v0-4-5-improving-user-network-connectivity/
tags: [General, NOS]
source: neonewstoday
---

# nOS releases Client v0.4.5 improving user network connectivity

**Published:** Wed, 31 Oct 2018 17:06:29 +0000
**URL:** https://neonewstoday.com/general/nos-releases-client-v0-4-5-improving-user-network-connectivity/
**Tags:** General, NOS
...
The post nOS releases Client v0.4.5 improving user network connectivity appeared first on Neo News Today.

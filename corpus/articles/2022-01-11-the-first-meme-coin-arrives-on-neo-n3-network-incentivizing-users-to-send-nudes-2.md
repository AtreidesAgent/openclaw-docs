---
title: "The first meme coin arrives on Neo N3 network, incentivizing users to send NUDES to each other"
date: 2022-01-11
url: https://neonewstoday.com/general/the-first-meme-coin-arrives-on-neo-n3-network-incentivizing-users-to-send-nudes-to-each-other/
tags: [General, Meme, GAS, NEO, NUDES, SkyHut]
source: neonewstoday
---

# The first meme coin arrives on Neo N3 network, incentivizing users to send NUDES to each other

**Published:** Tue, 11 Jan 2022 21:46:46 +0000
**URL:** https://neonewstoday.com/general/the-first-meme-coin-arrives-on-neo-n3-network-incentivizing-users-to-send-nudes-to-each-other/
**Tags:** General, Meme, GAS, NEO, NUDES, SkyHut
...
Users wishing to acquire NUDES will first need a Neo N3 wallet. To send assets or perform transactions on the Neo N3 network, a wallet must also have GAS. A new user may receive a GAS drop from the Nudes Army faucet, or swap for GAS through Flamingo Finance or various custodial exchanges (i.e., Binance, OKEx, CEX.io, Gate.io).

A list of Neo N3 compatible wallets are available on the neo.org website. Popular wallets within the community include: Neon Wallet, available on desktop and mobile; NeoLine, available on mobile or as a Chrome extension; O3, available on desktop and mobile; and, OneGate, available on mobile.

Users can visit the link below to request NUDES tokens on the Nudes Army Discord server:

https://discord.gg/R5r2tj8rHb

The post The first meme coin arrives on Neo N3 network, incentivizing users to send NUDES to each other appeared first on Neo News Today.

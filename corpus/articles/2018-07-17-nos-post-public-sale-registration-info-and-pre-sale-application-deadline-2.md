---
title: "nOS post public sale registration info and pre-sale application deadline"
date: 2018-07-17
url: https://neonewstoday.com/general/nos-post-public-sale-registration-info-and-pre-sale-application-deadline/
tags: [General, NOS]
source: neonewstoday
---

# nOS post public sale registration info and pre-sale application deadline

**Published:** Tue, 17 Jul 2018 00:50:06 +0000
**URL:** https://neonewstoday.com/general/nos-post-public-sale-registration-info-and-pre-sale-application-deadline/
**Tags:** General, NOS
...
- Developed a dApp on nOS,

- Contributed to the nOS Codebase on GitHub,

- Subscribed to the VDT.Network newsletter (prior to April 14th, 2018), and/or

- Participated in the nOS UI Design competition.

Pre-sale application instructions

To participate in the pre-sale, users will need to do the following:

- Download the nOS client (found at http://github.com/nos/client/releases),

- Open the client and log in with the NEO account established for participation,

- Sign up in the nOS client, by clicking the button in the “My nOS App” section, and
...
- Download the nOS client (found at http://github.com/nos/client/releases), and 

- Create an account (found at https://my.nos.app/).
...
https://medium.com/nos-io/nos-presale-application-deadline-tge-instructions-37c773e2d411 

More information about nOS can be found at the following links.
                                    

The post nOS post public sale registration info and pre-sale application deadline appeared first on Neo News Today.

---
title: "Nash adding new functionality to NEX token, changes to profit-sharing model"
date: 2021-12-15
url: https://neonewstoday.com/general/nash-adding-new-functionality-to-nex-token-changes-to-profit-sharing-model/
tags: [DeFi, General, Nash, NEX]
source: neonewstoday
---

# Nash adding new functionality to NEX token, changes to profit-sharing model

**Published:** Wed, 15 Dec 2021 19:26:40 +0000
**URL:** https://neonewstoday.com/general/nash-adding-new-functionality-to-nex-token-changes-to-profit-sharing-model/
**Tags:** DeFi, General, Nash, NEX
...
The post Nash adding new functionality to NEX token, changes to profit-sharing model appeared first on Neo News Today.
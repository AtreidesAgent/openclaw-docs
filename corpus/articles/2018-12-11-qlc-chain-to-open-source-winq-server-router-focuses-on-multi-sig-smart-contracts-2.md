---
title: "QLC Chain to open source WinQ server router, focuses on multi-sig smart contracts"
date: 2018-12-11
url: https://neonewstoday.com/general/qlc-chain-to-open-source-winq-server-router-focuses-on-multi-sig-smart-contracts/
tags: [General, QLC]
source: neonewstoday
---
...
**Published:** Tue, 11 Dec 2018 16:50:15 +0000
**URL:** https://neonewstoday.com/general/qlc-chain-to-open-source-winq-server-router-focuses-on-multi-sig-smart-contracts/
**Tags:** General, QLC
...
The post QLC Chain to open source WinQ server router, focuses on multi-sig smart contracts appeared first on Neo News Today.

---
title: "NEO Name Service now able to bind addresses with QR codes; NNC token lists on BitMart"
date: 2019-04-18
url: https://neonewstoday.com/general/neo-name-service-now-able-to-bind-addresses-with-qr-codes-nnc-token-lists-on-bitmart/
tags: [General, NEL, NNC, NNS]
source: neonewstoday
---

# NEO Name Service now able to bind addresses with QR codes; NNC token lists on BitMart

**Published:** Thu, 18 Apr 2019 21:59:17 +0000
**URL:** https://neonewstoday.com/general/neo-name-service-now-able-to-bind-addresses-with-qr-codes-nnc-token-lists-on-bitmart/
**Tags:** General, NEL, NNC, NNS
...
The post NEO Name Service now able to bind addresses with QR codes; NNC token lists on BitMart appeared first on Neo News Today.

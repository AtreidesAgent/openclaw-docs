---
title: "Alchemint to migrate half its token supply to Ethereum ERC-20 standard"
date: 2020-09-29
url: https://neonewstoday.com/general/alchemint-to-migrate-half-its-token-supply-to-ethereum-erc-20-standard/
tags: [General, SDS, SDUSD]
source: neonewstoday
---

# Alchemint to migrate half its token supply to Ethereum ERC-20 standard

**Published:** Tue, 29 Sep 2020 21:55:44 +0000
**URL:** https://neonewstoday.com/general/alchemint-to-migrate-half-its-token-supply-to-ethereum-erc-20-standard/
**Tags:** General, SDS, SDUSD
...
Alchemint is developing a portal on https://neo.alchemint.io/ for users to perform the Neo to Ethereum migration. Currently, the portal is not live and is still under development. Once it is ready, Alchemint intends to release a step-by-step guide for migrating NEP-5 tokens to the ERC-20 standard. Token migration will likely begin in October 2020. Alchemint notes that once tokens are converted from NEP-5 to ERC-20, the process is irreversible.
...
https://medium.com/@AlchemintIO/announcement-alchemint-sds-partially-migrating-to-eth-6c2e91e56a4e
                                    

The post Alchemint to migrate half its token supply to Ethereum ERC-20 standard appeared first on Neo News Today.
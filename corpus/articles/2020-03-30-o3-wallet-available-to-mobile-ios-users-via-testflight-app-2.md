---
title: "O3 wallet available to mobile iOS users via TestFlight app"
date: 2020-03-30
url: https://neonewstoday.com/general/o3-wallet-available-to-mobile-ios-users-via-testflight-app/
tags: [General, O3]
source: neonewstoday
---

# O3 wallet available to mobile iOS users via TestFlight app

**Published:** Mon, 30 Mar 2020 20:21:52 +0000
**URL:** https://neonewstoday.com/general/o3-wallet-available-to-mobile-ios-users-via-testflight-app/
**Tags:** General, O3

---

Following its removal from the Apple App Store in February 2020 due to a trademark dispute with a non-blockchain related company, the O3 wallet has been made available to iOS mobile users via the TestFlight platform. In October 2019, Neo Global Development (NGD) assumed responsibility of the O3 wallet after O3 Labs was acquired in a talent acquisition by Bitcoin.com to build mobile financial services for the Bitcoin Cash network.
...
https://twitter.com/O3_Labs/status/1244615072934068225?s=20
                                    

The post O3 wallet available to mobile iOS users via TestFlight app appeared first on Neo News Today.

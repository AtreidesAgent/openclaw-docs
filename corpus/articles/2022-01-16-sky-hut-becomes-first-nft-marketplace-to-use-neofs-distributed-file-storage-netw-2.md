---
title: "Sky Hut becomes first NFT marketplace to use NeoFS distributed file storage network"
date: 2022-01-16
url: https://neonewstoday.com/general/sky-hut-becomes-first-nft-marketplace-to-use-neofs-distributed-file-storage-network/
tags: [Exchanges, General, NFT, bNEO, FLM, GAS, NEO, NeoFS, NUDES, SkyHut]
source: neonewstoday
---

# Sky Hut becomes first NFT marketplace to use NeoFS distributed file storage network

**Published:** Sun, 16 Jan 2022 21:15:08 +0000
**URL:** https://neonewstoday.com/general/sky-hut-becomes-first-nft-marketplace-to-use-neofs-distributed-file-storage-network/
**Tags:** Exchanges, General, NFT, bNEO, FLM, GAS, NEO, NeoFS, NUDES, SkyHut
...
https://skyhut.app/dashboard

The post Sky Hut becomes first NFT marketplace to use NeoFS distributed file storage network appeared first on Neo News Today.

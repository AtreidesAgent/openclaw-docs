---
title: "QLC Chain approves 23 bugs from bounty, invites 50 users to beta test QDEX"
date: 2019-08-07
url: https://neonewstoday.com/general/qlc-chain-approves-23-bugs-from-bounty-invites-50-users-to-beta-test-qdex/
tags: [General, QGAS, QLC]
source: neonewstoday
---

# QLC Chain approves 23 bugs from bounty, invites 50 users to beta test QDEX

**Published:** Wed, 07 Aug 2019 00:51:51 +0000
**URL:** https://neonewstoday.com/general/qlc-chain-approves-23-bugs-from-bounty-invites-50-users-to-beta-test-qdex/
**Tags:** General, QGAS, QLC
...
- Making cryptocurrencies and tokens easy to buy and sell with fiat currency

- Allowing access to tokens that can “simplify the global top-up experience of telecom service[s]”

- Allowing users to stake QLC tokens
...
- Privacy protection that can only be validated on the QDEX

- Cross-chain interoperability on the QDEX platform

- An exchange for personal or Internet of Things (IoT) data
...
https://medium.com/qlc-chain/qlc-chain-bi-weekly-report-033-7499b27ebb4f
                                    

The post QLC Chain approves 23 bugs from bounty, invites 50 users to beta test QDEX appeared first on Neo News Today.
---
title: "Ontology prepare for MainNet ONT token swap"
date: 2018-06-09
url: https://neonewstoday.com/general/ontology-token-swap-oag-advisers-and-triones-candidates/
tags: [General, ONT]
source: neonewstoday
---

# Ontology prepare for MainNet ONT token swap

**Published:** Sat, 09 Jun 2018 15:30:52 +0000
**URL:** https://neonewstoday.com/general/ontology-token-swap-oag-advisers-and-triones-candidates/
**Tags:** General, ONT
...
For more information on the how to map and migrate visit the following link:
...
For those who are interested in serving as event coordinators for each of the meetups, contact either @dyassab#8943 or @JuliaYu#8100 on the Ontology Discord channel.

Triones Consensus Candidates

To view candidates listed to operate an Ontology Consensus Node visit the following link: 

https://info.ont.io/listtriones/en 

For more information about Ontology visit one of the links below.
                                    

The post Ontology prepare for MainNet ONT token swap appeared first on Neo News Today.

---
title: "NEO Global Capital invests in Splyse’s MCT with token purchase"
date: 2018-08-05
url: https://neonewstoday.com/general/neo-global-capital-invests-in-splyses-master-contract-token-with-token-purchase/
tags: [General, MCT, NGD]
source: neonewstoday
---

# NEO Global Capital invests in Splyse’s MCT with token purchase

**Published:** Sun, 05 Aug 2018 23:38:50 +0000
**URL:** https://neonewstoday.com/general/neo-global-capital-invests-in-splyses-master-contract-token-with-token-purchase/
**Tags:** General, MCT, NGD
...
- Support a written agreement between two parties.

- Use smart contracts to hold the token block in safe and transparent storage.

- Include sales clauses written into contracts, that require the owner of the contract (in this case, Splyse) approve the buyer before a token release and transfer can be finalized. 

- Deploy a smart contract at a costs of 90 GAS (as opposed to 490 GAS).

- Include unalterable release dates hard-coded into the smart contract. In this case, it implicates the support NGC has in the MCT token and its value for developers within the NEO ecosystem.
...
The post NEO Global Capital invests in Splyse’s MCT with token purchase appeared first on Neo News Today.